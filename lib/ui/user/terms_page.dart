...
class TermsState extends State<TermsWidget> {
  ...
  void initState() {
    ...
    FirebaseAnalytics.instance.setCurrentScreen(
      screenName: TermsPage.TAG_NAME,
      screenClassOverride: TermsPage.TAG_NAME,);
  }
  ...
  Widget _setLayout() {
    return Scaffold(
      appBar: AppBar(
        title: Text('이용약관', style: TStyle.commonTitle,),
            ...
            ConstrainedBox(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text('사용중인 앱 버전', style: TStyle.content14,),
                    Text(appVersion, style: TStyle.textMGrey,),
                  ],
                ),
              ),
            )
    ...
    return InkWell(
      child: ConstrainedBox(
        ...
        child: Container(
          ...
          child: Text(label, style: TStyle.content14,),
        ),
      ),
      onTap: (){
