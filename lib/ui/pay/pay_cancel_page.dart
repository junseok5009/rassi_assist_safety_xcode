...
class PayCancelState extends State<PayCancelWidget> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              const Text('결제일시  ', style: TStyle.textGreyDefault,),
              Text(_orderDate, style: TStyle.content16,),
            ],
          ),
          Row(
            children: [
              const Text('상  품  명  ', style: TStyle.textGreyDefault,),
              Text(_pdName, style: TStyle.content16,),
            ],
          ),
          Row(
            children: [
              const Text('금        액  ', style: TStyle.textGreyDefault,),
              Text(_paymentAmt, style: TStyle.content16,),
            ],
          ),
        ],
      ),
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                const Text('환불금액  ', style: TStyle.textGreyDefault,),
                Text(_refundAmt, style: TStyle.content16,),
              ],
            ),
          )
        ],
  ...
  Widget _setBottomDesc(String content) {
    return Container(
      ...
      child: Text(content, style: TStyle.defaultContent,),
    );
  }
