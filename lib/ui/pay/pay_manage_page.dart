          ...
          content: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const Text('해지안내', style: TStyle.title20, textScaleFactor: Const.TEXT_SCALE_FACTOR,),
                const SizedBox(height: 30.0,),
                const Text('해당 상품의 해지문의는\n 결제 고객센터로 연결해 주세요.', textAlign: TextAlign.center,
                  style: TStyle.defaultContent, textScaleFactor: Const.TEXT_SCALE_FACTOR,),
                const SizedBox(height: 30.0,),
                const Text('결제 고객센터',
                  style: TStyle.defaultContent, textScaleFactor: Const.TEXT_SCALE_FACTOR,),
                const SizedBox(height: 5.0,),
                Text(number,
                  style: TStyle.title22, textScaleFactor: Const.TEXT_SCALE_FACTOR,),
                const SizedBox(height: 15.0,),
              ],
            ),
          ),
