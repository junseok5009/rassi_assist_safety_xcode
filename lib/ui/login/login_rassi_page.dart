...
class RassiLoginPageState extends State<RassiLoginPage> {
  ...
  void initState() {
    ...
    CustomFirebaseClass.setUserProperty(CustomFirebaseProperty.LOGIN_STATUS, 'in_login_rassi');
  }
  ...
  Widget build(BuildContext context) {
    return KeyboardVisibilityBuilder(
        builder: (_, isKeyboardVisible) {
          ...
          appBar: CommonAppbar.basicColor(context, '', RColor.mainColor, Colors.white, Colors.white, 0,),
          body: SafeArea(
            child: LayoutBuilder(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Text(RString.desc_waiting_for_you, style: TStyle.introDesc,),
                              ...
                              Container(
                                ...
                                child: InkWell(
                                  child: const Text(RString.login, style: TStyle.btnTextWht16,),
                                  onTap: (){
          ...
          bottomSheet: isKeyboardVisible ? InkWell(
            child: Container(
              width: double.infinity,
              height: 60,
              color: RColor.deepBlue,
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              InkWell(
                child: const Text('아이디 찾기', style: TStyle.wtText,),
                onTap: (){
                  commonLaunchURL(Net.URL_FIND_TP_ID);
                },
              ),
              const Text(' / ', style: TStyle.wtText,),
              InkWell(
                child: const Text('비밀번호 찾기', style: TStyle.wtText,),
                onTap: (){
          ...
          InkWell(
            child: const Text(RString.join_think_pool, style: TStyle.wtText,),
            onTap: (){
  ...
  void _requestThink(String param) async {
    ...
    if(result != 'ERR' && result.length > 0) {
      ...
      commonShowToast('씽크풀 회원이 아니시거나 입력정보가 틀립니다. 아이디가 없으신 경우에는 회원가입을 해주시기 바랍니다.');
    }
  }
