...
import 'package:rassi_assist/custom_lib/charts_common/common.dart' show Color, LinkOrientation, Link;
...
class LinkRenderer<D> extends BaseSeriesRenderer<D> {
  ...
  void _drawAllLinks(List<LinkRendererElement> links, ChartCanvas canvas) {
    links.forEach((element) =>
        canvas.drawLink(element.link, element.orientation, element.fillColor as Color));
  }
