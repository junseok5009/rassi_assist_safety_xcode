...
import 'package:rassi_assist/custom_lib/charts_common/chart/common/selection_model/selection_model.dart';
import 'package:rassi_assist/custom_lib/charts_common/chart/common/series_renderer.dart';
import 'package:rassi_assist/custom_lib/charts_common/chart/layout/layout_config.dart';
...
class TreeMapChart<D> extends BaseChart<D> {
  ...
  SeriesRenderer<D> makeDefaultRenderer() {
    return SquarifiedTreeMapRenderer<D>()..rendererId = SeriesRenderer.defaultRendererId;
  }
