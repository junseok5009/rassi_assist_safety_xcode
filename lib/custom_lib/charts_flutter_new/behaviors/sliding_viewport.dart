...
import 'package:rassi_assist/custom_lib/charts_common/common.dart' as common
...
class SlidingViewport<D> extends ChartBehavior<D> {
  ...
  @override
  common.SlidingViewport<D> createCommonBehavior() => common.SlidingViewport<D>(selectionModelType);
