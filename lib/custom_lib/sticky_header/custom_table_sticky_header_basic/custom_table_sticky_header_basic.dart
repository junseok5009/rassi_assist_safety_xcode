...
class CustomCellDimensionsBasic {
  ...
  Size contentSize(int i, int j) {
    final width =
        (columnWidths != null ? columnWidths![j] : contentCellWidth) ?? base.contentCellWidth;
    final height =
        (rowHeights != null ? rowHeights![i] : contentCellHeight) ?? base.contentCellHeight;
    return Size(width!, height!);
  }

  double? stickyWidth(int i) =>
      (columnWidths != null ? columnWidths![i] : contentCellWidth) ?? base.contentCellWidth;
...
class CustomCellAlignmentsBasic {
  ...
  void runAssertions(int rowsLength, int columnsLength) {
    assert(contentCellAlignment != null || columnAlignments != null ||
        rowAlignments != null || contentCellAlignments != null);
