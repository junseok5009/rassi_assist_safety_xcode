...
class Const {
  static const bool isDebuggable = false; //상용버전[false] / 개발버전[true]
  static const BASE = "rassiapp";           //상용 서버
  //static const BASE = "rassiappdev"; //개발 서버
  static const APP_VER = '1.2.8'; //빌드 번호 가져오는 방법
  static const VER_CODE = 58;
  static const bool isSkeletonLoader = true;

  /// android set
  static const APP_VER_AOS = '1.2.8'; //안드로이드 버전
  static const VER_CODE_AOS = 121;
