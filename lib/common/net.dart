...
class Net {
  ...
  //로그인
  static const THINK_LOGIN = "https://olla.thinkpool.com/user/api/ajax/callLoginAjax.do";
  //회원가입
  static const THINK_JOIN = "https://olla.thinkpool.com/user/api/ajax/userJoinProcAjax.do";
  //인증번호 요청
  static const THINK_CERT_NUM = "https://olla.thinkpool.com/user/api/ajax/sendSMSAuthNumAjax.do";
  //인증번호 확인
  static const THINK_CERT_CONFIRM = "https://olla.thinkpool.com/user/api/ajax/sendSMSAuthNumProcAjax.do";
  //아이디 중복체크
  static const THINK_CHECK_ID = "https://olla.thinkpool.com/user/api/ajax/callProcConfirmIdAjax.do";
  //마케팅 동의 여부 설정
  static const THINK_EDIT_MARKETING = "https://olla.thinkpool.com/user/api/ajax/userEditProcAjax.do";
  //마케팅 동의 여부 정보
  static const THINK_INFO_MARKETING = "https://olla.thinkpool.com/user/api/ajax/userInfoProcAjax.do";
  //SNS 회원 체크
  static const THINK_SNS_LOGIN = "https://olla.thinkpool.com//user/api/ajax/callProcChkSNSIDMemberAjax.do";
  //SNS 회원 가입
  static const THINK_SNS_JOIN = "https://olla.thinkpool.com/user/api/ajax/callSnsUserJoinAjax.do";
  //비밀번호 변경
  static const THINK_CH_PASS = "https://olla.thinkpool.com/user/api/ajax/callProcChgPassWdAjax.do";
  //전화번호 변경
  static const THINK_CH_PHONE = "https://olla.thinkpool.com/user/api/ajax/callChangeHpnoAjax.do";
  //회원탈퇴
  static const THINK_USER_CLOSE = "http://olla.thinkpool.com/user/api/ajax/callProcThinkDismissAjax.do";
  //씽크풀 게시판
  static const THINK_COMMUNITY = "http://olla.thinkpool.com/bbs/list/s_pub.do";
  //씽크풀 게시판(종목)
  static const THINK_COMMUNITY_STK = "http://olla.thinkpool.com/bbs/list/stock_bbs.do?code=";
  //씽크풀 게시판(종목)
  static const NAVER_COMMUNITY_STK = "https://m.stock.naver.com/domestic/stock/";
  //씽크풀 게시판_로그인
  static const THINK_COMMUNITY_AJAX = "http://olla.thinkpool.com/user/api/ajax/callLoginBridgeAjax.do";
  //씽크풀 로그인 체크 / 결제 완료 체크 (휴면 방지)
  static const THINK_CHECK_DAILY = "https://olla.thinkpool.com/user/api/ajax/getUserLoginChkAjax.do";
  ...
  //종목 로고 파일
  static const URL_IMG_LOGO = "http://files.thinkpool.com/radarstock/company_logo/logo_%s.jpg";

  //씽크풀 아이디 찾기
  static const URL_FIND_TP_ID = 'https://sign.thinkpool.com/user/m/idInquiry.do';
  //씽크풀 비밀번호 찾기
  static const URL_FIND_TP_PW = 'https://sign.thinkpool.com/user/m/pwInquiry.do';


  // ===== 결제 =====
  static const TR_BASE_PAY = 'https://rassiapp.thinkpool.com:56610/rassi_pay/lgpay';
  static const TR_BASE_PAY_DEV = 'https://rassiappdev.thinkpool.com:56610/rassi_pay/lgpay';
  ...
  static String getEncrypt(String data) {
    ...
    return Uri.encodeQueryComponent(encStr, encoding: Encoding.getByName('utf-8')!);
  }
